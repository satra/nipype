...
preproc.inputs.inputspec.highpass = 100.0 / TR
...
l1pipeline.config = {
    "execution": {"crashdump_dir": os.path.abspath("./fsl_feeds/crashdumps")}
}
...
l1pipeline.connect(
    preproc, "outputspec.motion_parameters", modelspec, "realignment_parameters"
)
l1pipeline.connect(modelspec, "session_info", modelfit, "inputspec.session_info")
l1pipeline.connect(
    preproc, "outputspec.highpassed_files", modelfit, "inputspec.functional_data"
)
...
l1pipeline.connect(
    modelfit, "outputspec.zfiles", registration, "inputspec.source_files"
)
"""
Setup the datasink
"""

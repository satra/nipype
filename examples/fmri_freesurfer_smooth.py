...
normwreg = pe.MapNode(
    interface=fs.ApplyVolTransform(), iterfield=["source_file"], name="applyreg2con"
)
"""
    ...
    [
        (
            ...
            [
                ...
                ("threshold.binary_file", "level1design.mask_image"),
            ],
        ),
        (
            preproc,
...
l1pipeline.connect(
    [
        ...
        (
            volanalysis,
            volnorm,
            [("contrastestimate.con_images", "convertimg2nii.in_file")],
        ),
    ]
)
"""
    ...
    [
        ...
        (
            ...
            [
                ...
                (("subject_id", subjectinfo), "inputnode.session_info"),
            ],
        ),
    ]
)
...
level1.connect(
    [
        (
            infosource,
            datasink,
            [("subject_id", "container"), (("subject_id", getsubs), "substitutions")],
        ),
        (
            l1pipeline,
            datasink,
...
l2inputnode = pe.Node(
    interface=util.IdentityInterface(fields=["contrasts", "hemi"]), name="inputnode"
)
l2inputnode.iterables = [
    ("contrasts", list(range(1, len(contrasts) + 1))),
    ("hemi", ["lh", "rh"]),
]
"""

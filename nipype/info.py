...
REQUIRES = [
    ...
    'networkx>=%s,<=%s ; python_version < "3.0"'
    % (NETWORKX_MIN_VERSION, NETWORKX_MAX_VERSION_27),
    "nibabel>=%s" % NIBABEL_MIN_VERSION,
    'numpy>=%s ; python_version > "3.0" and python_version < "3.7"' % NUMPY_MIN_VERSION,
    'numpy>=%s ; python_version >= "3.7"' % NUMPY_MIN_VERSION_37,
    'numpy>=%s,!=%s,<%s ; python_version == "2.7"'
    % (NUMPY_MIN_VERSION, NUMPY_BAD_VERSION_27, NUMPY_MAX_VERSION_27),
    "packaging",
    ...
    'scipy>=%s,<%s ; python_version <= "3.4"'
    % (SCIPY_MIN_VERSION, SCIPY_MAX_VERSION_34),

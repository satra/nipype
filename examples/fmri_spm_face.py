...
preproc.connect(
    [
        ...
        (
            ...
            normalize_func,
            [
                ("timecorrected_files", "apply_to_files"),
...
cond1 = (
    ...
    "T",
    ["N1*bf(1)", "N2*bf(1)", "F1*bf(1)", "F2*bf(1)"],
    [1, 1, 1, 1],
)
cond2 = (
    "positive effect of condition_dtemo",
    "T",
    ["N1*bf(2)", "N2*bf(2)", "F1*bf(2)", "F2*bf(2)"],
    [1, 1, 1, 1],
)
cond3 = (
    "positive effect of condition_ddisp",
    "T",
    ["N1*bf(3)", "N2*bf(3)", "F1*bf(3)", "F2*bf(3)"],
    [1, 1, 1, 1],
)
# non-famous > famous
fam1 = (
    "positive effect of Fame",
    "T",
    ["N1*bf(1)", "N2*bf(1)", "F1*bf(1)", "F2*bf(1)"],
    [1, 1, -1, -1],
)
fam2 = (
    "positive effect of Fame_dtemp",
    "T",
    ["N1*bf(2)", "N2*bf(2)", "F1*bf(2)", "F2*bf(2)"],
    [1, 1, -1, -1],
)
fam3 = (
    "positive effect of Fame_ddisp",
    "T",
    ["N1*bf(3)", "N2*bf(3)", "F1*bf(3)", "F2*bf(3)"],
    [1, 1, -1, -1],
)
# rep1 > rep2
rep1 = (
    "positive effect of Rep",
    "T",
    ["N1*bf(1)", "N2*bf(1)", "F1*bf(1)", "F2*bf(1)"],
    [1, -1, 1, -1],
)
rep2 = (
    "positive effect of Rep_dtemp",
    "T",
    ["N1*bf(2)", "N2*bf(2)", "F1*bf(2)", "F2*bf(2)"],
    [1, -1, 1, -1],
)
rep3 = (
    "positive effect of Rep_ddisp",
    "T",
    ["N1*bf(3)", "N2*bf(3)", "F1*bf(3)", "F2*bf(3)"],
    [1, -1, 1, -1],
)
int1 = (
    "positive interaction of Fame x Rep",
    "T",
    ["N1*bf(1)", "N2*bf(1)", "F1*bf(1)", "F2*bf(1)"],
    [-1, -1, -1, 1],
)
int2 = (
    "positive interaction of Fame x Rep_dtemp",
    "T",
    ["N1*bf(2)", "N2*bf(2)", "F1*bf(2)", "F2*bf(2)"],
    [1, -1, -1, 1],
)
int3 = (
    "positive interaction of Fame x Rep_ddisp",
    "T",
    ["N1*bf(3)", "N2*bf(3)", "F1*bf(3)", "F2*bf(3)"],
    [1, -1, -1, 1],
)
...
subjectinfo_param = [
    Bunch(
        ...
        pmod=[
            None,
            Bunch(name=["Lag"], param=itemlag[1].tolist(), poly=[2]),
            None,
...
level1.connect(
    [
        (
            infosource,
            datasink,
            [("subject_id", "container"), (("subject_id", getstripdir), "strip_dir")],
        ),
        (
            l1pipeline,
            datasink,

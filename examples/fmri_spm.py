...
modelspec.inputs.time_repetition = 3.0
...
def getstripdir(subject_id):
    ...
    return os.path.join(
        os.path.abspath("spm_tutorial/workingdir"), "_subject_id_%s" % subject_id
    )
...
l1pipeline.connect(
    [
        ...
        (
            art,
            datasink,
            [("outlier_files", "art.@outliers"), ("statistic_files", "art.@stats")],
        ),
        ...
        (
            contrastestimate,
            datasink,
            [("con_images", "contrasts.@con"), ("spmT_images", "contrasts.@T")],
        ),
    ]
)
"""
